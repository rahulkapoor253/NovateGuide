...
public class FacebookManager {
     ...
     */
    public void getFbUserDetails(final CallbackManager mCallbackManager, final ResponseHandler facebookResponseHandler) {
        ...
        try {
            ...
            LoginManager.getInstance().registerCallback(mCallbackManager, new FacebookCallback<LoginResult>() {
                        ...
                        public void onCompleted(final JSONObject object, final GraphResponse response) {
                            ...
                            if (response.getError() != null) {
                                ...
                                try {
                                    ...
                                    Log.i(TAG, object + "");
                                    SocialData mSocialUserDetails = new SocialData(object.getString(ID),
                ...
                public void onCancel() {
                    facebookResponseHandler.onCancel(mContext.getString(R.string.facebook_login_failed));
                }
